...
public class Moneda { 
	...
	public void aPesos() {
		...
		switch (opcionMoneda) {
		case "Dolar":
			cambio = conversor.convertirAPesos( this.dolar);
			JOptionPane.showMessageDialog(null," es igual a $ " + cambio + " Pesos");
			break;
		case"Euros":
			cambio = conversor.convertirAPesos(this.euro);
			JOptionPane.showMessageDialog(null, " es igual a $ " + cambio + " Pesos");
			break;
		case "Libras-esterlinas":
			cambio = conversor.convertirAPesos(this.libra );
			JOptionPane.showMessageDialog(null,"es igual a $ " + cambio + " Pesos");
			break;
		case "Yen-japonés":
			cambio = conversor.convertirAPesos(this.yen);
			JOptionPane.showMessageDialog(null, " es igual a $ " + cambio + " Pesos");
			break;
		case "Won-surcoreano":
			cambio = conversor.convertirAPesos(this.won);
			JOptionPane.showMessageDialog(null, " es igual a $ " + cambio + " Pesos");
			break;
		}
	}
